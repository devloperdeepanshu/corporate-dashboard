...
function EmployeePerformanceDashboard() {
  const kpiAnimations = {
  ...
  // Filter KPIs relevant to Performance
  const performanceKpis = hrData.kpis.filter((kpi) =>
    ["Attendance", "Avg Tenure", "Attrition Rate"].includes(kpi.title)
  );
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          ...
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={hrData.departmentStats}>
